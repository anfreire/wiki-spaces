...
Pinned upstream skills, vendored as sparse copies. Each sub-directory is an autonomous wiki-spaces space (per [`AGENTS.md`](../AGENTS.md) `## Sharing & nesting`) — refreshed in-place by `scripts/vendor_kepano.py`, never edited by hand.
